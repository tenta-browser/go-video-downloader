...
func init() {
	λ.InitModule(func() {
		...
		JWPlatformIE = λ.Cal(λ.TypeType, λ.NewStr("JWPlatformIE"), λ.NewTuple(InfoExtractor), func() λ.Dict {
			...
			JWPlatformIE__VALID_URL = λ.NewStr("(?:https?://(?:content\\.jwplatform|cdn\\.jwplayer)\\.com/(?:(?:feed|player|thumb|preview|video|manifest)s|jw6|v2/media)/|jwplatform:)(?P<id>[a-zA-Z0-9]{8})")
