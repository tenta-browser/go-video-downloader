 ...
 *
 * jwplatform/module.go: transpiled from https://github.com/rg3/youtube-dl/blob/master/youtube_dl/extractor/jwplatform.py
 */
...
func init() {
	λ.InitModule(func() {
		...
		JWPlatformIE = λ.Cal(λ.TypeType, λ.NewStr("JWPlatformIE"), λ.NewTuple(InfoExtractor), func() λ.Dict {
			var (
				JWPlatformIE__TEST         λ.Object
				JWPlatformIE__VALID_URL    λ.Object
				JWPlatformIE__real_extract λ.Object
			)
			JWPlatformIE__VALID_URL = λ.NewStr("(?:https?://content\\.jwplatform\\.com/(?:feeds|players|jw6)/|jwplatform:)(?P<id>[a-zA-Z0-9]{8})")
			JWPlatformIE__TEST = λ.NewDictWithTable(map[λ.Object]λ.Object{
			...
			JWPlatformIE__real_extract = λ.NewFunction("_real_extract",
				...
				func(λargs []λ.Object) λ.Object {
					...
					ϒjson_data = λ.Cal(λ.GetAttr(ϒself, "_download_json", nil), λ.Mod(λ.NewStr("http://content.jwplatform.com/feeds/%s.json"), ϒvideo_id), ϒvideo_id)
					return λ.Cal(λ.GetAttr(ϒself, "_parse_jwplayer_data", nil), ϒjson_data, ϒvideo_id)
				})
			return λ.NewDictWithTable(map[λ.Object]λ.Object{
				λ.NewStr("_TEST"):         JWPlatformIE__TEST,
