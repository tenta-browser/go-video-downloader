 ...
 *
 * xvideos/module.go: transpiled from https://github.com/rg3/youtube-dl/blob/master/youtube_dl/extractor/xvideos.py
 */
		...
		XVideosIE = λ.Cal(λ.TypeType, λ.NewStr("XVideosIE"), λ.NewTuple(InfoExtractor), func() λ.Dict {
			...
			XVideosIE__real_extract = λ.NewFunction("_real_extract",
				...
				func(λargs []λ.Object) λ.Object {
					...
					ϒwebpage = λ.Cal(λ.GetAttr(ϒself, "_download_webpage", nil), λ.Mod(λ.NewStr("http://www.xvideos.com/video%s/"), ϒvideo_id), ϒvideo_id)
