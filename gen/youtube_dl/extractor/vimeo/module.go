						...
						defer λ.CatchMulti(
							func() {
								if λ.IsTrue(λ.Eq(λ.Cal(λ.GetAttr(ϒconfig, "get", nil), λ.NewStr("view")), λ.NewInt(4))) {
									ϒconfig = λ.Cal(λ.GetAttr(ϒself, "_verify_player_video_password", nil), ϒredirect_url, ϒvideo_id)
								}
							},
			...
			VimeoReviewIE__get_config_url = λ.NewFunction("_get_config_url",
				...
				func(λargs []λ.Object) λ.Object {
					...
					if λ.IsTrue(λ.NewBool(!λ.IsTrue(ϒconfig_url))) {
						...
						ϒconfig_url = λ.Cal(λ.GetAttr(λ.Cal(λ.GetAttr(λ.Cal(λ.GetAttr(ϒdata, "get", nil), λ.NewStr("vimeo_esi"), λ.NewDictWithTable(map[λ.Object]λ.Object{})), "get", nil), λ.NewStr("config"), λ.NewDictWithTable(map[λ.Object]λ.Object{})), "get", nil), λ.NewStr("configUrl"))
					}
