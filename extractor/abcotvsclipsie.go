...
func (self *ABCOTVSClipsIE) _real_extract(url string) rnt.SDict {
	...
	formats = (self).ExtractM3U8Formats((rnt.StrSplit(rnt.CastToString(rnt.UnsafeSubscript(video_data, "videoURL")), "?", -(1)))[0], video_id, rnt.AsOptString("mp4"), rnt.AsOptString("m3u8"), rnt.OptFloat{}, rnt.OptString{}, rnt.OptString{}, rnt.OptString{}, true, false)
