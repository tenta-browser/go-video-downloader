...
func (self *ABCOTVSIE) _real_extract(url string) rnt.SDict {
	...
	formats = (self).ExtractM3U8Formats(m3u8, display_id.Get(), rnt.AsOptString("mp4"), rnt.AsOptString("m3u8"), rnt.OptFloat{}, rnt.OptString{}, rnt.OptString{}, rnt.OptString{}, true, false)
