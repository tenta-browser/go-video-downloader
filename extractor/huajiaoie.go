...
func (self *HuajiaoIE) _real_extract(url string) rnt.SDict {
	...
	return rnt.SDict{
		...
		"formats":     (self).ExtractM3U8Formats(rnt.CastToString(rnt.UnsafeSubscript(rnt.UnsafeSubscript(feed, "feed"), "m3u8")), video_id, rnt.AsOptString("mp4"), rnt.AsOptString("m3u8_native"), nil, rnt.OptString{}, rnt.OptString{}, rnt.OptString{}, true, false),
	}
}
