...
func (self *VidioIE) _real_extract(url string) rnt.SDict {
	...
	formats = (self).ExtractM3U8Formats(rnt.CastToString(m3u8_url), display_id.Get(), rnt.AsOptString("mp4"), rnt.AsOptString("m3u8_native"), rnt.OptFloat{}, rnt.OptString{}, rnt.OptString{}, rnt.OptString{}, true, false)
